...
| `FRONTEND_URL` | `https://study-os-raval-gauarngs-projects.vercel.app` | Allowed CORS origin |
...
| Variable Key | Production Value | Purpose |
| :--- | :--- | :--- |
| `NEXT_PUBLIC_APP_URL` | `https://study-os-raval-gauarngs-projects.vercel.app` | Stable Production Domain for client redirects & metadata |
